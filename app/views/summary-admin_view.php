...
<div class="app-dash-panel">
    <div style="width:100%; height:fit-content; margin: 0px auto">
        ...
        <div class="drawer">
            ...
            <button class="button-solid round" id="btn-transparent" onclick="releaseGeneratedSummary()">Release Summary</button>
            <button class="button-solid round" id="btn-transparent" onclick="generateSummaryPDF()">Generate PDF</button>
        </div>
        <div class="table">
